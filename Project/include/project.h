...
#define BOX_LFT_RGT_DIRICHLET 1  // left and right sides of box dirichlet
#define BOX_BOT_TOP_DIRICHLET 1  // top and bottom sides of box dirichlet
#endif
...
void init_Sim_data(Sim_data *sim, int n_input, double dt_input, double tend_input, double save_freq,
                   const char *myPath);
